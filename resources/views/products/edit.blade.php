...
<head>
    ...
    <title>Edit Produk - FreshFruit</title>
...
<body class="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-orange-50">
    ...
    <main class="max-w-2xl mx-auto px-6 py-10">
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-800">Edit Produk ✏️</h1>
            <p class="text-gray-500 text-sm mt-1">Perbarui detail produk di bawah ini.</p>
        </div>
